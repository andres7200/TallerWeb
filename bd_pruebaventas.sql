...
--
-- Servidor: localhost
-- Tiempo de generación: 23-09-2021 a las 04:14:25
...
INSERT INTO `cliente` (`IdCliente`, `Dni`, `Nombres`, `Direccion`, `Estado`, `User`) VALUES
(17, '2', 'Juan Guerrero Solis', 'Los Alamos', '1', 'jill'),
(18, '1', 'Maria Rosas Villanueva', 'Los Laureles 234', '1', 'juli');
...
(1, '123', 'Soy yo actualizado24', '988252459', '1', 'emp');
...
--
ALTER TABLE `empleado`
  MODIFY `IdEmpleado` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
